...
#include "dls2_interface/msg/detail/pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dls2_interface::msg::Pose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dls2_interface::msg::Pose & ros_message)
{
  // Member: position
  {
    cdr >> ros_message.position;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dls2_interface::msg::Pose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dls2_interface::msg::Pose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dls2_interface::msg::Pose *>(
    untyped_ros_message);
...
{
  return &dls2_interface::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dls2_interface, msg, Pose)() {
  return &dls2_interface::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
