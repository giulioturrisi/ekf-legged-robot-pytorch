...
#include "dls2_interface/msg/detail/base_state__rosidl_typesupport_fastrtps_c.h"
...
#include "dls2_interface/msg/detail/pose__functions.h"  // pose
#include "dls2_interface/msg/detail/screw__functions.h"  // acceleration, velocity
#include "rosidl_runtime_c/primitives_sequence.h"  // stance_status
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // stance_status
...
using _BaseState__ros_msg_type = dls2_interface__msg__BaseState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = ros_message->stance_status.size;
    auto array_ptr = ros_message->stance_status.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: stance_status
  {
    ...
    if (ros_message->stance_status.data) {
      rosidl_runtime_c__boolean__Sequence__fini(&ros_message->stance_status);
    }
    if (!rosidl_runtime_c__boolean__Sequence__init(&ros_message->stance_status, size)) {
      fprintf(stderr, "failed to create array for field 'stance_status'");
      return false;
    }
    auto array_ptr = ros_message->stance_status.data;
...
size_t get_serialized_size_dls2_interface__msg__BaseState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BaseState__ros_msg_type * ros_message = static_cast<const _BaseState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BaseState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dls2_interface__msg__BaseState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dls2_interface
size_t max_serialized_size_dls2_interface__msg__BaseState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dls2_interface__msg__BaseState;
    is_plain =
      (
...
static size_t _BaseState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dls2_interface__msg__BaseState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dls2_interface, msg, BaseState)() {
