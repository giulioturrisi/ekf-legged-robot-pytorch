...
_colcon_prefix_sh_COLCON_CURRENT_PREFIX="/home/gturrisi-iit.local/other_ws_home/iekf-legged-robot-pytorch/ros2_ws/install"
...
if [ -n "$COLCON_PYTHON_EXECUTABLE" ]; then
  ...
  _colcon_python_executable="/home/gturrisi-iit.local/miniforge3/envs/ekf_legged_robot_env/bin/python3.12"
